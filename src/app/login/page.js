...
const Login = () => {
    ...
    const { notifData, handleNotifAction, handleNotifVisible } =
        useNotification();
    ...
    return (
        <section className="grid h-screen grid-cols-12">
            <div className={`relative  col-span-4 h-full`}>
                ...
                >
                    <h1 className="text-[40px] font-bold leading-[20px]">
                        Hallo !
                    </h1>
                    <p className="text-center ">
                        Masukkan Detail Pribadi Anda dan Mulailah Pembelajaran
                        Anda
                    </p>
                    <BorderedButton
                        theme="light"
                ...
                <div className="flex w-[646px] flex-col gap-[42px]">
                    <div className="text-center">
                        ...
                        <p className="text-body-2">
                            Buktikan Sekarang Semua Bisa Belajar
                        </p>
                    </div>
                    <form
                            ...
                            <PasswordInputRef
                                ...
                                {...register("password", {
                                    ...
                                    minLength: {
                                        value: 8,
                                        message:
                                            "Jumlah Karaktek tidak boleh kurang dari 8!",
                                    },
                                })}
                                className={`${
                                    errors.password?.message
